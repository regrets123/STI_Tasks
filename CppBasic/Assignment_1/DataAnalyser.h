...
public:
    ...
    {}
    template<typename Container> //used overloads earlier instead of template container, but managed to get this work, and it's a more DRY approach.
...
private:
    ...
    //However, if you have to support localisation, which most modern software do you need even more abstraction of the string data, which is why I'm not changing this.
    ...
    const char* findTemperatureMsg = "Enter the temperature you want to look for in the data. First input accuracy (ex: 0.1), then temperature: ";
