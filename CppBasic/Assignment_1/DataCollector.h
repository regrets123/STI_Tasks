...
public:
    ...
    std::unordered_map<time_t ,float>* GetData() {return &dataCollection;}
    
private:
    std::array<std::string,4> prompts {"Enter the amount of data pairs of time <-> value you want to input:", "Enter value number:","Enter time <-> value pair number:","Generating random DataSet:"};
